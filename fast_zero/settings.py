...
class Settings(BaseSettings):
    ...
    DATABASE_NAME: str = Field(default='fastapi_db', description='Database name')
    DATABASE_USER: str = Field(default='fastapi_user', description='Database user')
    DATABASE_PASSWORD: str = Field(default='fastapi_password', description='Database password')
    ...
    MAX_LOGIN_ATTEMPTS: int = Field(
        default=5,
        description='Maximum login attempts (alias)',
        ge=3,
        le=20
    )
